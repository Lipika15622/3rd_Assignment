...
$user_feedbacks = array_filter($feedbacks, function($feedback) use ($user_email) {
    return $feedback['user_email'] == $user_email;
});
...
<main class="">
    <div class="relative flex min-h-screen overflow-hidden bg-gray-50 py-6 sm:py-12">
     ...
     <a href = feedback.php><span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your feedback form link: <strong>http://localhost/feedback/sYu24jl</strong></span>
        </a>     </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div class="relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
                    <div class="focus:outline-none">
                        <p class="text-gray-500"> <?php foreach ($user_feedbacks as $feedback): ?>
